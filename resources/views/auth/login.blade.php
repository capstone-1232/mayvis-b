         ...
         <div class="row vh-100">
            ...
            <div class="col-lg-5 col-md-6 px-md-5 my-auto mx-auto login-div">
               ...
               <div class="px-5">
                  <form action="{{ route('login') }}" method="POST" id="login-form">
                     ...
                     <div class="form-group mb-2">
                        <div class="flex items-center justify-end mb-2">
                           ...
                           <a class="text-decoration-underline fs-5 text-secondary" href="{{ route('password.request') }}">
                  ...
                  <div class="d-flex justify-content-center btn btn-outline-dark w-100 rounded-pill">

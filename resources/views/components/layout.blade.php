...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body>
        ...
        <div class="sidebar sidebar-icon-only d-flex flex-column">
          ...
          <nav class="nav flex-column flex-grow-1">
            <a class="nav-link active" href="#"><i class="fas fa-home fa-lg me-auto"></i><span> Home</span></a>
            <a class="nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#proposalsSubmenu" aria-expanded="false" aria-controls="proposalsSubmenu">
            ...
            <a class="nav-link" href="#"><i class="fas fa-cogs fa-lg"></i><span> Services</span></a>
            <a class="nav-link" href="#"><i class="fas fa-users fa-lg"></i><span> Clients</span></a>

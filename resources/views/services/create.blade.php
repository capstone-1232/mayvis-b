            ...
            <div class="bg-white p-4 rounded-4 mt-2 mb-4">
                <form action="{{ route('services.storeProduct') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <x-text-input type="text" name="product_name" class="form-control rounded-pill" :value="old('product_name')"></x-text-input>
                        <x-input-error class="mt-2 productserr" :messages="$errors->get('product_name')" />
                    </div>
    
                    <div class="form-group mb-3">
                        <label for="product_description">Product Description</label>
                        <x-text-input type="text" name="product_description" class="form-control rounded-pill" :value="old('product_description')"></x-text-input>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="notes" name="product_notes"></textarea>
                    </div>
    
                    <div class="form-group mb-3">
                        <label for="price">Product Price</label>
                        <x-text-input type="text" name="price" class="form-control rounded-pill" :value="old('price')"></x-text-input>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <x-text-input type="text" name="created_by" class="form-control rounded-pill" value="{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}"></x-text-input>

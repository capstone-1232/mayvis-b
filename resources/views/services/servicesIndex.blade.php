       ...
       document.addEventListener('DOMContentLoaded', function () {
           ...
           let productsHtml = '';
            data.forEach(product => {
                ...
                const truncatedDescription = truncateDescription(product.description || product.product_description, 100);
                productsHtml += `
                    <div class="mb-3">
                            ...
                            <div class="card-body d-flex flex-column">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <div class="card-text ms-2 mt-2 product-card-description">${truncatedDescription}</div>
                                    </div>
                                    <div class="text-end text-secondary fst-italic product-summary">
                        ...
                        <div class="card h-100 border rounded-4 shadow-sm custom-hover">
                            <div class="card-body d-flex flex-column">
                                <div class="top-part d-flex justify-content-between">
                                    <div class="left-part">
                                        <h5 class="card-title display-5 fw-bold mb-0">
                                            <a href="{{ route('services.edit', $product) }}" class="stretched-link text-decoration-none text-dark">
                                                {{ $product->product_name }}
                                            </a>
                                        </h5>
                                        <div class="card-text product-card-description ms-2 mt-2">
                                            {!! Str::limit($product->product_description, 100, '...') !!}
                                        </div>
                                    </div>
                                    <div class="text-end text-secondary fst-italic fs-6 product-summary">

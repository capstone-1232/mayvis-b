<x-layout>
    ...
    <div class="content">
       <div class="my-4">
          ...
          <div class="container">
             <div class="p-4 bg-white rounded-5 shadow col-lg-8 col-sm-12 mx-auto mt-5">
                <div class="px-4">
                   <div class="">
                      <div class="d-flex justify-content-between align-items-center">
                   ...
                   <form action="{{ route('proposals.storeStep1') }}" method="post">
                      ...
                      <div class="mb-3">
                         ...
                         <x-text-input type="tel" name="phone_number" field="phone_number" placeholder="7809998888" class="w-100" autocomplete="off" :value="old('phone_number', session('step1_data.phone_number', ''))" ></x-text-input>
                      </div>

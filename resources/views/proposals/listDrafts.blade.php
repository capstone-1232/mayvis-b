                            ...
                            <tbody id="tableBody">
                                ...
                                @forelse ($drafts as $draft)
                                    <tr>
                                        ...
                                        <td class="align-middle d-none d-md-table-cell text-center">${{ $draft->proposal_price }}</td>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <a href="{{ route('proposals.viewDraftSummary', $draft->id) }}" class="btn primary-btn text-white rounded-pill w-100 fw-bold">Resume</a>
                                        </td>

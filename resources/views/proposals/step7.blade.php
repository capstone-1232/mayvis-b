                    ...
                    <div class="col-md-10 mx-auto">
                        ...
                        <div class="row my-5 d-flex">
                            <div class="col-md-6 d-flex">
                                <div class="p-4 shadow-sm rounded-5 bg-white d-flex flex-column flex-grow-1">
                                    <div class="col-10 mx-auto flex-grow-1">
                                        <h3 class="mb-2 fw-bold fs-4 text-center">Send a PDF Copy</h3>
                            ...
                            <div class="col-md-6 d-flex mt-3 mt-md-0">
                                <div class="p-4 shadow-sm rounded-5 bg-white d-flex flex-column flex-grow-1">
                                    <div class="col-10 mx-auto flex-grow-1">
                                        <h3 class="mb-2 fw-bold fs-4 text-center">Send using a link</h3>
                        ...
                        <a href="{{ route('proposals.step6') }}" class="fs-7 fw-semi-bold me-2 back-btn"><i class="bi bi-caret-left me-2"></i>Go Back</a>
                    </div>
                </div>
            </div>
        </div>

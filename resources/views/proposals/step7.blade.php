                ...
                <div class="p-6 bg-white border-b border-gray-200 text-center">
                    ...
                    <div class="flex justify-around items-center mb-6">
                        ...
                        <div class="p-4 max-w-sm bg-gray-100 rounded-lg border border-gray-200 shadow-md">
                            ...
                            <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Send Link</button>
                        </div>
                    </div>

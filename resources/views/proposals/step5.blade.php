            ...
            <div class="p-6 mt-2 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('proposals.storeStep5') }}" method="POST">
                    ...
                    <div id="product-{{ $productId }}">
                        ...
                        <button type="button" onclick="editPrice('{{ $productId }}')" id="edit-button-{{ $productId }}">Edit</button>
                        <button type="button" onclick="savePrice('{{ $productId }}')" id="save-button-{{ $productId }}" style="display:none;">Save</button>
                    </div>
                    @endforeach
                    ...
                    <p>Recurring Total: $<span id="recurringTotalDisplay">{{ number_format($step4Data['recurringTotal'] ?? 0, 2, '.', ',') }}</span></p>

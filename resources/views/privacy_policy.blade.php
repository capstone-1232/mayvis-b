    ...
    <div class="">
        <div class="container my-5">
            <div class="mb-5">
                ...
                <p class="lead">This Privacy Policy governs how Mayvis ("we", "us", or "our") collects, uses, maintains, and discloses information collected from users (each, a "User") of the Mayvis website ("Site"). This privacy policy applies to the Site and all products and services offered by Mayvis.</p>
            </div>
            
            <div class="mb-5">
                <h2 class="fw-bold">Information We Collect</h2>
            ...
            <div class="mb-5">
                <h2 class="fw-bold">How We Use Your Information</h2>
            ...
            <div class="mb-5">
                <h2 class="fw-bold">Information Sharing</h2>
            ...
            <div class="mb-5">
                <h2 class="fw-bold">Your Choices</h2>
            ...
            <div>
                <h2 class="fw-bold">Changes to Terms</h2>
